...
const ModalCreateUser: React.FC<ModalCreateUserProps> = ({ isOpen, onDidDismiss }) => {
    const [formData, setFormData] = useState<CreateUserType>({ badgeId: "", password: "", name: "", role: "Basic", DepartmentId: "", LineId: "" });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        mutate(formData);
        setFormData({ badgeId: "", password: "", name: "", role: "Basic", DepartmentId: "", LineId: "" });
        onDidDismiss();
    }
    return (
