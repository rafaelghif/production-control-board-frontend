...
const ContainerUser: React.FC = () => {
    ...
    return (
        <>
                        ...
                        <Card title="Data User">
                            {isLoading ? (
                                ...
                                <Suspense fallback={<IonSpinner name="crescent" />}>
                                    <TableUser data={data} handleClickBtnEdit={(data) => handleClickBtnEdit(data)} />
                                </Suspense>
                            )}
                        </Card>
                    </IonCol>
            ...
            <ModalUpdateUser data={selectValue} isOpen={isOpenModalUpdate} onDidDismiss={() => setIsOpenModalUpdate(false)} />
        </>
    );
}
