...
import OrderInformationColumn from "@/features/input-order-features/components/OrderInformationColumn";
import OrderInformationGrid from "@/features/input-order-features/components/OrderInformationGrid";
import { Suspense, lazy, useRef, useState } from "react";

import Card from "../../../components/Card";
import { useLineStore } from "../../../stores";
import { OrderResponseType } from "../../../types";
import { useCreateOrderNode } from "../hooks";
import { useGetOrderInputNode } from "../hooks/useGetOrderInputNode";
...
const ContainerInputOrder: React.FC = () => {
	...
	const orderInput = useGetOrderInputNode();
	const createOrder = useCreateOrderNode();
