...
const TableControlBoardPlanning = lazy(() => import("./TableControlBoardPlanning"));
...
const ContainerControlBoardPlanning: React.FC = () => {
    ...
    const [selectValue, setSelectValue] = useState<ControlBoardPlanningInterface>();
    ...
    return (
        <>
                        ...
                        <Card title="Data Control Board Planning">
                            {isLoading ? (
                                ...
                                <Suspense fallback={<IonSpinner name="crescent" />}>
                                    <TableControlBoardPlanning data={data} handleClickBtnEdit={(data) => handleClickBtnEdit(data)} />
                                </Suspense>
                            )}
                        </Card>
                    </IonCol>
            ...
            <ModalUpdateControlBoardPlanning isOpen={isOpenModalUpdate} data={selectValue} onDidDismiss={() => setIsOpenModalUpdate(false)} />
        </>
    );
}
