...
import { ControlBoardPlanningInterface, ControlBoardPlanningWithLineInterface } from "../../../types/control-board-planning-type";
...
const TableControlBoardPlanning: React.FC<TableControlBoardPlanningProps> = ({ data = [], handleClickBtnEdit }) => {
    const columns: TableColumn<ControlBoardPlanningWithLineInterface>[] = useMemo(() => [{
        name: "Date",
    ...
    return (
        <Table columns={columns} data={data} responsive pagination striped highlightOnHover expandableRows expandableRowsComponent={ContainerControlBoardPlanningDetail} />
    );
}
