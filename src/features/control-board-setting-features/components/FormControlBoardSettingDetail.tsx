...
const FormControlBoardSettingDetail: React.FC<FormControlBoardSettingDetailProps> = ({ value, onChange }) => {
    const [controlBoardSetting, setControlBoardSetting] = useState<CreateControlBoardSettingDetailType>({ time: "07:00", qty: 0, sequence: 1 });

    const handleInput = (key: keyof CreateControlBoardSettingDetailType, value: string | number) => {
