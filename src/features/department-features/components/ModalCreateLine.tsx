...
const ModalCreateLine: React.FC<ModalCreateLineProps> = ({ isOpen, departmentId, onDidDismiss }) => {
    const [formData, setFormData] = useState<CreateLineType>({ name: "", DepartmentId: departmentId });
    ...
    useEffect(() => {
        setFormData((prevState) => ({ ...prevState, DepartmentId: departmentId }));
    }, [departmentId]);
