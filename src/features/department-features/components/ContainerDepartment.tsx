...
const ContainerDepartment: React.FC = () => {
    ...
    return (
        <>
                        ...
                        <Card title="Data Department">
                            {isLoading ? (
                                ...
                                <Suspense fallback={<IonSpinner name="crescent" />}>
                                    <TableDepartment data={data} handleClickBtnEdit={(data) => handleClickBtnEdit(data)} />
                                </Suspense>
                            )}
                        </Card>
                    </IonCol>
            ...
            <ModalUpdateDepartment data={selectValue} isOpen={isOpenModalUpdate} onDidDismiss={() => setIsOpenModalUpdate(false)} />
        </>
    );
}
